...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"default_bootcmd=run cp_kernel2ram && bootm ${netstart}\0" \ 
        "qspi_load_img=load mmc ${sdbootdev} 0x1000000 qspi_load_img.img && source 0x1000000\0" \
        "qspi_load_goldenimg=load mmc ${sdbootdev} 0x1000000 qspi_load_goldenimg.img && source 0x1000000\0" \
""
