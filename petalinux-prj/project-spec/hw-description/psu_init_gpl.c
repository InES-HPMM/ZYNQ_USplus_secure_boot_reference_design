...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180140, 0x03FFFFFFU ,0x00001080U)
    */
	PSU_Mask_Write(IOU_SLCR_BANK0_CTRL3_OFFSET,
		0x03FFFFFFU, 0x00001080U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180168, 0x03FFFFFFU ,0x03F8003FU)
    */
	PSU_Mask_Write(IOU_SLCR_BANK1_CTRL6_OFFSET,
		0x03FFFFFFU, 0x03F8003FU);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180184, 0x03FFFFFFU ,0x00034000U)
    */
	PSU_Mask_Write(IOU_SLCR_BANK2_CTRL6_OFFSET,
		0x03FFFFFFU, 0x00034000U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * CSU regsiter
    *  PSU_CSU_TAMPER_STATUS_TAMPER_0                              1

    * External MIO
    *  PSU_CSU_TAMPER_STATUS_TAMPER_1                              1

    * JTAG toggle detect
    *  PSU_CSU_TAMPER_STATUS_TAMPER_2                              1

    * PL SEU error
    *  PSU_CSU_TAMPER_STATUS_TAMPER_3                              1

    * AMS over temperature alarm for LPD
    *  PSU_CSU_TAMPER_STATUS_TAMPER_4                              1

    * AMS over temperature alarm for APU
    *  PSU_CSU_TAMPER_STATUS_TAMPER_5                              1

    * AMS voltage alarm for VCCPINT_FPD
    *  PSU_CSU_TAMPER_STATUS_TAMPER_6                              1

    * AMS voltage alarm for VCCPINT_LPD
    *  PSU_CSU_TAMPER_STATUS_TAMPER_7                              1

    * AMS voltage alarm for VCCPAUX
    *  PSU_CSU_TAMPER_STATUS_TAMPER_8                              1

    * AMS voltage alarm for DDRPHY
    *  PSU_CSU_TAMPER_STATUS_TAMPER_9                              1

    * AMS voltage alarm for PSIO bank 0/1/2
    *  PSU_CSU_TAMPER_STATUS_TAMPER_10                             1

    * AMS voltage alarm for PSIO bank 3 (dedicated pins)
    *  PSU_CSU_TAMPER_STATUS_TAMPER_11                             1

    * AMS voltaage alarm for GT
    *  PSU_CSU_TAMPER_STATUS_TAMPER_12                             1

    * Tamper Response Status
    * (OFFSET, MASK, VALUE)      (0XFFCA5000, 0x00001FFFU ,0x00001FFFU)
    */
	PSU_Mask_Write(CSU_TAMPER_STATUS_OFFSET, 0x00001FFFU, 0x00001FFFU);
/*##################################################################### */
    ...
    */
    /*
    * Register : csu_tamper_0 @ 0XFFCA5004

    * Zeroize Non-volatile BBRAM key in addtion to the tamper resposne specifi
    * ed.
    *  PSU_CSU_CSU_TAMPER_0_BBRAM_ERASE                            0

    * Setting this bit causes the CSU ROM to issue a secure lockdown when the
    * tamper event occurs. Only the action of the most significant bit is take
    * n.
    *  PSU_CSU_CSU_TAMPER_0_SEC_LOCKDOWN_0                         1

    * CSU Tamper Response 0
    * (OFFSET, MASK, VALUE)      (0XFFCA5004, 0x00000024U ,0x00000004U)
    */
	PSU_Mask_Write(CSU_CSU_TAMPER_0_OFFSET, 0x00000024U, 0x00000004U);
/*##################################################################### */

    /*
    * Register : csu_tamper_1 @ 0XFFCA5008

    * Zeroize Non-volatile BBRAM key in addtion to the tamper resposne specifi
    * ed.
    *  PSU_CSU_CSU_TAMPER_1_BBRAM_ERASE                            0

    * Setting this bit causes the CSU ROM to issue a secure lockdown when the
    * tamper event occurs. Only the action of the most significant bit is take
    * n.
    *  PSU_CSU_CSU_TAMPER_1_SEC_LOCKDOWN_0                         1

    * CSU Tamper Response 1
    * (OFFSET, MASK, VALUE)      (0XFFCA5008, 0x00000014U ,0x00000004U)
    */
	PSU_Mask_Write(CSU_CSU_TAMPER_1_OFFSET, 0x00000014U, 0x00000004U);
/*##################################################################### */

    /*
    * Register : csu_tamper_2 @ 0XFFCA500C

    * Zeroize Non-volatile BBRAM key in addtion to the tamper resposne specifi
    * ed.
    *  PSU_CSU_CSU_TAMPER_2_BBRAM_ERASE                            0

    * Setting this bit causes the CSU ROM to issue a secure lockdown when the
    * tamper event occurs. Only the action of the most significant bit is take
    * n.
    *  PSU_CSU_CSU_TAMPER_2_SEC_LOCKDOWN_0                         1

    * CSU Tamper Response 2
    * (OFFSET, MASK, VALUE)      (0XFFCA500C, 0x00000014U ,0x00000004U)
    */
	PSU_Mask_Write(CSU_CSU_TAMPER_2_OFFSET, 0x00000014U, 0x00000004U);
/*##################################################################### */

    /*
    * Register : csu_tamper_3 @ 0XFFCA5010

    * Zeroize Non-volatile BBRAM key in addtion to the tamper resposne specifi
    * ed.
    *  PSU_CSU_CSU_TAMPER_3_BBRAM_ERASE                            0

    * Setting this bit causes the CSU ROM to issue a secure lockdown when the
    * tamper event occurs. Only the action of the most significant bit is take
    * n.
    *  PSU_CSU_CSU_TAMPER_3_SEC_LOCKDOWN_0                         1

    * CSU Tamper Response 3
    * (OFFSET, MASK, VALUE)      (0XFFCA5010, 0x00000014U ,0x00000004U)
    */
	PSU_Mask_Write(CSU_CSU_TAMPER_3_OFFSET, 0x00000014U, 0x00000004U);
/*##################################################################### */

    /*
    * Register : csu_tamper_4 @ 0XFFCA5014

    * Zeroize Non-volatile BBRAM key in addtion to the tamper resposne specifi
    * ed.
    *  PSU_CSU_CSU_TAMPER_4_BBRAM_ERASE                            0

    * Setting this bit causes the CSU ROM to issue a secure lockdown when the
    * tamper event occurs. Only the action of the most significant bit is take
    * n.
    *  PSU_CSU_CSU_TAMPER_4_SEC_LOCKDOWN_0                         1

    * CSU Tamper Response 4
    * (OFFSET, MASK, VALUE)      (0XFFCA5014, 0x00000014U ,0x00000004U)
    */
	PSU_Mask_Write(CSU_CSU_TAMPER_4_OFFSET, 0x00000014U, 0x00000004U);
/*##################################################################### */

    /*
    * Register : csu_tamper_5 @ 0XFFCA5018

    * Zeroize Non-volatile BBRAM key in addtion to the tamper resposne specifi
    * ed.
    *  PSU_CSU_CSU_TAMPER_5_BBRAM_ERASE                            0

    * Setting this bit causes the CSU ROM to issue a secure lockdown when the
    * tamper event occurs. Only the action of the most significant bit is take
    * n.
    *  PSU_CSU_CSU_TAMPER_5_SEC_LOCKDOWN_0                         1

    * CSU Tamper Response 5
    * (OFFSET, MASK, VALUE)      (0XFFCA5018, 0x00000014U ,0x00000004U)
    */
	PSU_Mask_Write(CSU_CSU_TAMPER_5_OFFSET, 0x00000014U, 0x00000004U);
/*##################################################################### */

    /*
    * Register : csu_tamper_6 @ 0XFFCA501C

    * Zeroize Non-volatile BBRAM key in addtion to the tamper resposne specifi
    * ed.
    *  PSU_CSU_CSU_TAMPER_6_BBRAM_ERASE                            0

    * Setting this bit causes the CSU ROM to issue a secure lockdown when the
    * tamper event occurs. Only the action of the most significant bit is take
    * n.
    *  PSU_CSU_CSU_TAMPER_6_SEC_LOCKDOWN_0                         1

    * CSU Tamper Response 6
    * (OFFSET, MASK, VALUE)      (0XFFCA501C, 0x00000014U ,0x00000004U)
    */
	PSU_Mask_Write(CSU_CSU_TAMPER_6_OFFSET, 0x00000014U, 0x00000004U);
/*##################################################################### */

    /*
    * Register : csu_tamper_7 @ 0XFFCA5020

    * Zeroize Non-volatile BBRAM key in addtion to the tamper resposne specifi
    * ed.
    *  PSU_CSU_CSU_TAMPER_7_BBRAM_ERASE                            0

    * Setting this bit causes the CSU ROM to issue a secure lockdown when the
    * tamper event occurs. Only the action of the most significant bit is take
    * n.
    *  PSU_CSU_CSU_TAMPER_7_SEC_LOCKDOWN_0                         1

    * CSU Tamper Response 7
    * (OFFSET, MASK, VALUE)      (0XFFCA5020, 0x00000014U ,0x00000004U)
    */
	PSU_Mask_Write(CSU_CSU_TAMPER_7_OFFSET, 0x00000014U, 0x00000004U);
/*##################################################################### */

    /*
    * Register : csu_tamper_8 @ 0XFFCA5024

    * Zeroize Non-volatile BBRAM key in addtion to the tamper resposne specifi
    * ed.
    *  PSU_CSU_CSU_TAMPER_8_BBRAM_ERASE                            0

    * Setting this bit causes the CSU ROM to issue a secure lockdown when the
    * tamper event occurs. Only the action of the most significant bit is take
    * n.
    *  PSU_CSU_CSU_TAMPER_8_SEC_LOCKDOWN_0                         1

    * CSU Tamper Response 8
    * (OFFSET, MASK, VALUE)      (0XFFCA5024, 0x00000014U ,0x00000004U)
    */
	PSU_Mask_Write(CSU_CSU_TAMPER_8_OFFSET, 0x00000014U, 0x00000004U);
/*##################################################################### */

    /*
    * Register : csu_tamper_9 @ 0XFFCA5028

    * Zeroize Non-volatile BBRAM key in addtion to the tamper resposne specifi
    * ed.
    *  PSU_CSU_CSU_TAMPER_9_BBRAM_ERASE                            0

    * Setting this bit causes the CSU ROM to issue a secure lockdown when the
    * tamper event occurs. Only the action of the most significant bit is take
    * n.
    *  PSU_CSU_CSU_TAMPER_9_SEC_LOCKDOWN_0                         1

    * CSU Tamper Response 9
    * (OFFSET, MASK, VALUE)      (0XFFCA5028, 0x00000014U ,0x00000004U)
    */
	PSU_Mask_Write(CSU_CSU_TAMPER_9_OFFSET, 0x00000014U, 0x00000004U);
/*##################################################################### */

    /*
    * Register : csu_tamper_10 @ 0XFFCA502C

    * Zeroize Non-volatile BBRAM key in addtion to the tamper resposne specifi
    * ed.
    *  PSU_CSU_CSU_TAMPER_10_BBRAM_ERASE                           0

    * Setting this bit causes the CSU ROM to issue a secure lockdown when the
    * tamper event occurs. Only the action of the most significant bit is take
    * n.
    *  PSU_CSU_CSU_TAMPER_10_SEC_LOCKDOWN_0                        1

    * CSU Tamper Response 10
    * (OFFSET, MASK, VALUE)      (0XFFCA502C, 0x00000014U ,0x00000004U)
    */
	PSU_Mask_Write(CSU_CSU_TAMPER_10_OFFSET, 0x00000014U, 0x00000004U);
/*##################################################################### */

    /*
    * Register : csu_tamper_11 @ 0XFFCA5030

    * Zeroize Non-volatile BBRAM key in addtion to the tamper resposne specifi
    * ed.
    *  PSU_CSU_CSU_TAMPER_11_BBRAM_ERASE                           0

    * Setting this bit causes the CSU ROM to issue a secure lockdown when the
    * tamper event occurs. Only the action of the most significant bit is take
    * n.
    *  PSU_CSU_CSU_TAMPER_11_SEC_LOCKDOWN_0                        1

    * CSU Tamper Response 11
    * (OFFSET, MASK, VALUE)      (0XFFCA5030, 0x00000014U ,0x00000004U)
    */
	PSU_Mask_Write(CSU_CSU_TAMPER_11_OFFSET, 0x00000014U, 0x00000004U);
/*##################################################################### */

    /*
    * Register : csu_tamper_12 @ 0XFFCA5034

    * Zeroize Non-volatile BBRAM key in addtion to the tamper resposne specifi
    * ed.
    *  PSU_CSU_CSU_TAMPER_12_BBRAM_ERASE                           0

    * Setting this bit causes the CSU ROM to issue a secure lockdown when the
    * tamper event occurs. Only the action of the most significant bit is take
    * n.
    *  PSU_CSU_CSU_TAMPER_12_SEC_LOCKDOWN_0                        1

    * CSU Tamper Response 12
    * (OFFSET, MASK, VALUE)      (0XFFCA5034, 0x00000014U ,0x00000004U)
    */
	PSU_Mask_Write(CSU_CSU_TAMPER_12_OFFSET, 0x00000014U, 0x00000004U);
/*##################################################################### */
