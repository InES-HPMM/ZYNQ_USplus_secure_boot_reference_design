/* 
 * Crypto API example for SHA3-384 on the Xilinx Zynq Ultrascale+
 *
 * Calculate a SHA3-384 hash with the crypto hardware of the Xilinx Zynq
 * Ultrascale+ and the Linux Crypto API.
 *
...
#define SHA_HASH_SIZE 48 /* sha3-384 hash is 48 byte long */
...
int main () {
	...
	/* create structure and select the hash algorithm sha3-384 */
